...
def main():
    ...
    parser.add_argument('-t', '--token', type=str, default='__data/secrets/TOKEN',
            help='path to telegram bot token file')
    parser.add_argument('-d', '--data', type=str, default='__data/storage',
            help='path for data storage directory')
    parser.add_argument('-v', '--verbose', action='count', default=0)
    args = parser.parse_args()

    log_level = [logging.ERROR, logging.WARNING, logging.INFO, logging.DEBUG][min(args.verbose, 4)]
